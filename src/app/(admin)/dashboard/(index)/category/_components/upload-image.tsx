...
export default function UploadImage({ data = "" }: UploadImageProps) {
  ...
  useEffect(() => {
    if (data) {
      setImage(getImageUrl(data, "category"));
    }
  }, [data]);
  ...
  return (
    <div className="flex flex-col space-y-1.5">
      ...
      <div className="grid gap-2 border rounded-md p-2">
        <Image alt="Gambar Kategori" onClick={openFolder} className="aspect-square w-full rounded-md object-cover border" height={300} width={300} src={image || "/placeholder.svg"} />
